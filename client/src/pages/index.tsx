...
const SalesThisWeek: FC = function () {
  return (
    <div className="rounded-lg bg-white p-4 px-20 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
      <div>
        <div className=" bg-white">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:gap-8">
            <div className="post p-5 lg:p-1 rounded-md lg:col-span-2">
              <div className=" p-4 bg-white mt-3" id="posted">
